...
<input type="text" class="form-control" name="Fname" id="FirstName" placeholder="Enter Your First Name" class="input">
        </div>
        <div class="inputField">
          <label for="Lname" class="labelInput  pt-2">Last Name</label>
<input type="text" class="form-control" name="Lname" id="LastName" placeholder="Enter Your Last Name" class="input">
        </div>
        <div class="inputField">
        ...
        <div class="inputField">
          <label for="contactNo" class="labelInput  pt-2">Contact Number</label>
              <input type="text" class="form-control" name="contactNo" id="ContactNumber" placeholder="Enter Your Contact Number" class="input">
        </div>
        ...
        <div class="inputField">
          ...
          <input type="date" class="form-control" name="dob" id="Date" placeholder="Enter Your Date Of Birth" class="input">
        </div>
  ...
  <div class="inputField row">
    <div class="col-sm-12 col-md-10 password-container">
      ...
      <button type="button" class="toggle-password btn btn-outline-secondary" data-target="confirmpassword">Show</button>
    </div>
  </div>
